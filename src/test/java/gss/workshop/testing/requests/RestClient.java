...
public class RestClient extends TestBase {
   ...
   */
  public static Response doPostRequestWithParamsAndNoPayload(String requestPath, Map<String, String> params) {
    return given()
        .queryParams(params)
        .contentType(ContentType.ANY)
        .when()
   ...
   */
  public static Response doPutRequestWithParamsAndNoPayload(String requestPath, Map<String, String> params) {
    return given()
        .queryParams(params)
        .contentType(ContentType.ANY)
        .when()
